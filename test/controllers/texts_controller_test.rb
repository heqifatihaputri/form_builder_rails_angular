...
class TextsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create text" do
    assert_difference('Text.count') do
      post texts_url, params: { text: { half_width: @text.half_width, label_name: @text.label_name, required_field: @text.required_field } }
    end
  ...
  test "should update text" do
    patch text_url(@text), params: { text: { half_width: @text.half_width, label_name: @text.label_name, required_field: @text.required_field } }
